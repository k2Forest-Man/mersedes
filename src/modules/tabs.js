const tabsModule = () => {
  let tabsHandlerElements = document.querySelectorAll('[data-tabs-handler]');
  let tabsContentElements = document.querySelectorAll('[data-tabs-field]');
  let tabsHeaderElements = document.querySelectorAll('[data-tabs-header]');
